...
function wl_auth_mode_change(isload){
	...
	if(mode == "psk" || mode == "psk2" || mode == "pskpsk2" || mode == "psk3" || mode == "psk2psk3" || mode == "wpa" || mode == "wpa2" ||mode == "wpawpa2"){
		...
		else if(opts[opts.selectedIndex].text == "WPA2-Personal" || opts[opts.selectedIndex].text == "WPA2-Enterprise" || opts[opts.selectedIndex].text == "WPA3-Personal" || opts[opts.selectedIndex].text == "WPA2/WPA3-Personal")
			algos = new Array("AES");
		else
	...
	if(sw_mode == 2){
			if(based_modelid.search("RP-AC66") != -1)
				...
				if((based_modelid == "RT-AC87U" && '<% nvram_get("wl_unit"); %>' == '1'))
					...
					var auth_array = [["Open System", "open"], ["Shared Key", "shared"], ["WPA-Personal", "psk"], ["WPA2-Personal", "psk2"], ["WPA-Auto-Personal", "pskpsk2"], ["WPA3-Personal", "psk3"], ["WPA2/WPA3-Personal", "psk2psk3"]];
			}
	}
		...
		if((based_modelid == "RT-AC87U" && '<% nvram_get("wl_unit"); %>' == '1') || g_unit != undefined)
			...
			var auth_array = [["Open System", "open"], ["WPA2-Personal", "psk2"], ["WPA-Auto-Personal", "pskpsk2"], ["WPA3-Personal", "psk3"], ["WPA2/WPA3-Personal", "psk2psk3"], ["WPA2-Enterprise", "wpa2"], ["WPA-Auto-Enterprise", "wpawpa2"]];
	}
	else{		//Legacy
		if((based_modelid == "RT-AC87U" && '<% nvram_get("wl_unit"); %>' == '1') || g_unit != undefined){
			var auth_array = [["Open System", "open"], ["WPA2-Personal", "psk2"], ["WPA-Auto-Personal", "pskpsk2"]];
			...
			if(wifi_logo_support)
				...
				var auth_array = [["Open System", "open"], ["Shared Key", "shared"], ["WPA-Personal", "psk"], ["WPA2-Personal", "psk2"], ["WPA-Auto-Personal", "pskpsk2"], ["WPA3-Personal", "psk3"], ["WPA2/WPA3-Personal", "psk2psk3"], ["WPA-Enterprise", "wpa"], ["WPA2-Enterprise", "wpa2"], ["WPA-Auto-Enterprise", "wpawpa2"], ["Radius with 802.1x", "radius"]];
		}
	}
