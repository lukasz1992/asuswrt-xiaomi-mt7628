...
void mt7628_set_ed_cca(RTMP_ADAPTER *pAd, BOOLEAN enable)
{
	...
	{
		/* After mt7603 ACI issue task, the edcca could be always opened;
		* set ED threshold to -65dbm;
		* disable PSE RESET.
		* For MAP set ED threshold to -20dbm(0xd7e82a10);
		*/
		macVal = 0xd7e82a10;
		RTMP_IO_WRITE32(pAd, WF_PHY_BASE + 0x0618, macVal);
		...
		RTMP_IO_READ32(pAd, TMAC_TRCR, &macVal3);
		macVal3 |= 0xc0000000;
		RTMP_IO_WRITE32(pAd, TMAC_TRCR, macVal3);
	}
